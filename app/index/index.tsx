...
const Navbar = () => {
  ...
  return (
    <header className="bg-green-200 text-black shadow-md fixed top-0 left-0 w-full z-50">
...
const HomePage = () => {
  return (
    ...
    <div>
      <Navbar />
      <div className="flex flex-col md:flex-row items-center justify-between px-8 md:px-20 py-12 bg-white mt-3">
        {/* Text Content */}
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start gap-4">
            ...
            <Link href="/signup">
            <button className="border-2 bg-green-500 border-green-500 text-white-500 py-2 px-6 rounded hover:bg-neutral-200 hover:text-black transition duration-300">
              Signup
            </button>
            </Link>
          </div>
        ...
        <div className="relative flex-1 mt-8 md:mt-0 flex justify-center">
          {/* Red Card */}
          <div className="absolute -top-12 -right-16 bg-red-500 w-40 h-40 sm:w-64 sm:h-64 rounded-xl transform rotate-12 z-0 mt-48"></div>

          {/* Image */}
          <img
            src="/Cool-Parties-1.jpg" // Ensure the image is in your public folder or adjust the path accordingly
            alt="Influencer Partnership"
        ...
        <br /><br /><br /><br /><br />
      <main className="bg-gradient-to-b from-white to-green-300 py-20 ">
        {/* Main Content */}
